...
ORDER_FAILED = (
    "Не получилось оформить заказ — сбой на нашей стороне. Мы уже видим ошибку.\n\n"
    "Ничего не списано. Попробуйте ещё раз через пару минут или напишите в поддержку."
)
PAYMENT_LINK = (
...
ACTIVATION_UNEXPECTED = (
    "Не удалось завершить настройку — сбой на нашей стороне. "
    "Мы уже видим ошибку и разбираемся. Попробуйте ещё раз через несколько минут: "
    "деньги и дни подписки не потеряются, отсчёт начнётся только после успешной настройки."
)
