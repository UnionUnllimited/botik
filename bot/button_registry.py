...
BUTTON_REGISTRY: list[dict[str, Any]] = [
    ...
    _b('btn_router_update',        'shop', 'Обновить прошивку роутера',       '⤓ Обновить прошивку',   ''),
    _b('btn_router_panel',         'shop', 'Админка роутера (домашняя сеть)', 'Админка роутера',       ''),
    _b('btn_router_instruction',   'shop', 'Инструкция (в «Моём роутере»)',   'Инструкция',            ''),
    _b('btn_router_setup',         'shop', 'Как подключить (в заказе)',       'Как подключить',        ''),
    _b('btn_shop_buy',             'shop', 'Заказать модель',                 'Заказать',               ''),
    _b('btn_shop_back_to_list',    'shop', 'Назад к списку моделей',          '‹ К списку моделей',    ''),
    _b('btn_shop_cancel_order',    'shop', 'Отменить оформление',             '✕ Отменить',            ''),
    _b('btn_shop_speed',           'shop', 'Вариант скорости доставки',       'Доставка',              ''),
    _b('btn_shop_carrier',         'shop', 'Выбор перевозчика',               'Перевозчик',            ''),
    _b('btn_shop_pickup_map',      'shop', 'Карта пунктов выдачи',            '◇ Выбрать пункт выдачи', ''),
    ...
    _b('btn_shop_orders_all',      'shop', 'Показать отменённые заказы',      'Показать отменённые',   ''),
...
DEFAULT_MAIN_MENU_LAYOUT: list[list[str]] = [
    # Порядок под роутеры: сначала своё устройство и продление, затем покупка.
    ...
    #
    # Витрина стоит первой строкой намеренно: зашедший впервые не знает,
