...
def code_email_html(code: str, project_name: str = "VPN") -> str:
...
def subscription_activated_html(sub_url: str, expiry: str, project_name: str = "VPN", happ_key: str = None) -> str:
    key_block = ""
    if happ_key:
        key_block = f"""
