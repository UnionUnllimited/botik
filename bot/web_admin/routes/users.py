...
def attach_user_routes(admin_bp_instance, query_db_func, execute_db_func):
    ...
    async def users_list():
        ...
        client_routers_map, client_subs_map, client_traffic_map, _ = await shop_api.routers_of_clients(
        ...
        return await render_template(
            ...
            client_traffic_map=client_traffic_map,
            page=page,
    ...
    async def user_details(telegram_id):
        ...
        return await render_template(
            ...
            client_panel_used=client_routers_data.get('panel_used_bytes'),
            payments=payments,
            promo=promo,
