...
ADMIN_ANSWERS = {
    ...
    "qa_reset": (
        ...
        "только Wi-Fi (станет <b>Titan-2.4</b> / <b>Titan-5</b>, "
        "пароль <code>11111118</code>) и пароль панели "
        "(<code>admin</code> / <code>admin</code>).\n\n"
        "✅ <b>Подписка, VPN, выбранные серверы и настройки "
        "провайдера сохраняются.</b> Сброс их не трогает.\n\n"
        "Если забыли пароль от панели — это как раз тот случай, "
        "когда долгое нажатие уместно."
    ),
