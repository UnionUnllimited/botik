...
Сайт и бэкенд для продажи роутеров с подпиской на сервис стабильного доступа
к зарубежным ресурсам: витрина и заказы, личный кабинет, активация устройств,
выдача подписки роутерам, админка и управление парком.

Telegram-бот вынесен из этого стека: за основу взят сторонний продукт в `bot/`,
