...
PRODUCT = {
    ...
    "old_price": "7900.00",
    "stock": 3,
    # Сколько ещё можно продать по нынешнему пределу: число со склада минус
    # живые заказы. Колонка «Остаток» показывает именно его — товар,
    # разобранный заказами, не должен выглядеть лежащим на полке.
    "stock_left": 1,
...
PAGES = {
    ...
    "catalog_settings.html": {
        ...
        "orders_topic_chat_id": "-1001234567890",
        "landing_images": {
    ...
    "firmware_updates.html": {
        "firmware_error": "",
        "models": [
            {"key": "cudy,wr3000e-v1", "title": "Cudy WR3000E"},
            {"key": "cudy,wr3000s-v1", "title": "Cudy WR3000S"},
            {"key": "cudy,tr3000-v1", "title": "Cudy TR3000"},
            {"key": "zbtlink,zbt-z8103ax-c", "title": "ZBT Z8103AX-C"},
        ],
        "rollout_steps": [0, 5, 25, 50, 100],
        "rollout_warning": "Возврат в 0 останавливает раздачу новым роутерам.",
        "manifest_url": "https://shop.example/firmware/manifest.json",
