...
PARTNER_MAX_ATTEMPTS = 10
"""То же для очереди чужих колбэков — уведомлений об оплате, которые
зачисляет бот, а приходят они к нам.

Вдвое больше, чем у сообщений, и это разница в цене. Не дошло сообщение —
клиент не узнал новости. Не дошёл колбэк — клиент заплатил и не получил
оплаченного. Лишние попытки здесь дешевле преждевременной сдачи."""
