...
GUIDE_SECTIONS: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "text": "Напечатаны на наклейке снизу роутера. Сменить их можно в его "
        "домашней панели — адрес и кнопка входа есть в боте, в разделе «Мой роутер». "
        "Панель открывается только из вашей домашней сети.",
    },
    {
        "glyph": "↻",
    ...
    },
    {
        ...
        "text": "Сначала проверьте кабель провайдера и питание, потом перезагрузите "
        "роутер — вынуть вилку на десять секунд и включить обратно. Если не помогло, "
        "загляните в «Мой роутер»: там видно, на связи он или молчит.",
    },
    {
        "glyph": "▤",
    ...
    },
    {
        "glyph": "◈",
        "title": "Поддержка",
        "text": "Пишите в бот. Мы видим состояние роутера со своей стороны и можем "
