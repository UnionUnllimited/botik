...
INSTRUCTION_STEPS: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "в шапке панели и на странице titan.lan/my-mac). Пока переоформляют, "
        "можно включить Titan за старый роутер: провод из обычного порта "
        "старого — в порт «Интернет» нового.",
    },
    {
        "glyph": "ⓘ",
