...
дешевле, но ждать недельной отправки. Перевозчик — забота оператора:
...
DEFAULT_SPEED_DESCRIPTIONS = {
    DeliverySpeed.FAST: (
        ...
        "Дороже, зато не нужно ждать общей отправки."
    ),
    DeliverySpeed.WEEKLY: (
        "Отправляем партией раз в неделю. Дешевле, но посылка ждёт "
