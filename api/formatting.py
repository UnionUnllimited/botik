"""Форматирование значений для страниц: деньги, даты, статусы, объёмы.

Одни и те же фильтры нужны и админке, и сайту, поэтому лежат отдельно
от окружений Jinja: у админки и у клиентских страниц они разные.
"""
